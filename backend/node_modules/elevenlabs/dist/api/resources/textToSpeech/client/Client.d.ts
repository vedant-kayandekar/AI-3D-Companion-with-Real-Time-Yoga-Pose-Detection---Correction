...
export declare class TextToSpeech {
     ...
     *     })
     */
    convertWithTimestamps(voiceId: string, request: ElevenLabs.TextToSpeechWithTimestampsRequest, requestOptions?: TextToSpeech.RequestOptions): Promise<ElevenLabs.AudioWithTimestampsResponse>;
    /**
     ...
     */
    streamWithTimestamps(voiceId: string, request: ElevenLabs.StreamTextToSpeechWithTimestampsRequest, requestOptions?: TextToSpeech.RequestOptions): Promise<core.Stream<ElevenLabs.StreamingAudioChunkWithTimestampsResponse>>;
}
