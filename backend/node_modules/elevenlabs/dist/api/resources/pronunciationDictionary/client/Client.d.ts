...
export declare class PronunciationDictionary {
     ...
     *     })
     */
    addFromRules(request: ElevenLabs.BodyAddAPronunciationDictionaryV1PronunciationDictionariesAddFromRulesPost, requestOptions?: PronunciationDictionary.RequestOptions): Promise<ElevenLabs.AddPronunciationDictionaryResponseModel>;
    /**
     ...
     *     })
     */
    addRules(pronunciationDictionaryId: string, request: ElevenLabs.PronunciationDictionary, requestOptions?: PronunciationDictionary.RequestOptions): Promise<ElevenLabs.PronunciationDictionaryRulesResponseModel>;
    /**
     ...
     *     })
     */
    removeRules(pronunciationDictionaryId: string, request: ElevenLabs.RemovePronunciationDictionaryRulesRequest, requestOptions?: PronunciationDictionary.RequestOptions): Promise<ElevenLabs.PronunciationDictionaryRulesResponseModel>;
    /**
     * Get a PLS file with a pronunciation dictionary version rules
     * @throws {@link ElevenLabs.UnprocessableEntityError}
     */
    download(dictionaryId: string, versionId: string, requestOptions?: PronunciationDictionary.RequestOptions): Promise<stream.Readable>;
    /**
