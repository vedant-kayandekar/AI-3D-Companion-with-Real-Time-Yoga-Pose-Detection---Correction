...
var Vector = class _Vector {
   ...
   */
  add(v) {
    if (v instanceof _Vector)
      return new _Vector(this.x + v.x, this.y + v.y, this.z + v.z);
    else
      return new _Vector(this.x + v, this.y + v, this.z + v);
  }
  /**
   ...
   */
  cross(v) {
    return new _Vector(this.y * v.z - this.z * v.y, this.z * v.x - this.x * v.z, this.x * v.y - this.y * v.x);
  }
  /**
  ...
  // static methods //
  static negative(a, b = new _Vector()) {
    b.x = -a.x;
    b.y = -a.y;
    b.z = -a.z;
    return b;
  }
  static add(a, b, c = new _Vector()) {
    if (b instanceof _Vector) {
      c.x = a.x + b.x;
      c.y = a.y + b.y;
      c.z = a.z + b.z;
    } else {
  ...
  static subtract(a, b, c = new _Vector()) {
    if (b instanceof _Vector) {
      c.x = a.x - b.x;
      c.y = a.y - b.y;
      c.z = a.z - b.z;
  ...
  static multiply(a, b, c = new _Vector()) {
    if (b instanceof _Vector) {
      c.x = a.x * b.x;
      c.y = a.y * b.y;
      c.z = a.z * b.z;
  ...
  static divide(a, b, c = new _Vector()) {
    if (b instanceof _Vector) {
      c.x = a.x / b.x;
      c.y = a.y / b.y;
      c.z = a.z / b.z;
  ...
  static cross(a, b, c = new _Vector()) {
    c.x = a.y * b.z - a.z * b.y;
    c.y = a.z * b.x - a.x * b.z;
    c.z = a.x * b.y - a.y * b.x;
    return c;
  ...
  static fromAngles(theta, phi) {
    return new _Vector(Math.cos(theta) * Math.cos(phi), Math.sin(phi), Math.sin(theta) * Math.cos(phi));
  }
  static randomDirection() {
    return _Vector.fromAngles(Math.random() * TWO_PI, Math.asin(Math.random() * 2 - 1));
  }
  static min(a, b) {
    return new _Vector(Math.min(a.x, b.x), Math.min(a.y, b.y), Math.min(a.z, b.z));
  }
  static max(a, b) {
    return new _Vector(Math.max(a.x, b.x), Math.max(a.y, b.y), Math.max(a.z, b.z));
  }
  /**
  ...
  static fromArray(a) {
    if (Array.isArray(a)) {
      return new _Vector(a[0], a[1], a[2]);
    }
    return new _Vector(a.x, a.y, a.z);
  }
  /**
  ...
  static findRotation(a, b, normalize = true) {
    if (normalize) {
      return new _Vector(_Vector.normalizeRadians(_Vector.find2DAngle(a.z, a.x, b.z, b.x)), _Vector.normalizeRadians(_Vector.find2DAngle(a.z, a.y, b.z, b.y)), _Vector.normalizeRadians(_Vector.find2DAngle(a.x, a.y, b.x, b.y)));
    } else {
      return new _Vector(_Vector.find2DAngle(a.z, a.x, b.z, b.x), _Vector.find2DAngle(a.z, a.y, b.z, b.y), _Vector.find2DAngle(a.x, a.y, b.x, b.y));
    }
  }
  /**
  ...
  static rollPitchYaw(a, b, c) {
    if (!c) {
      return new _Vector(_Vector.normalizeAngle(_Vector.find2DAngle(a.z, a.y, b.z, b.y)), _Vector.normalizeAngle(_Vector.find2DAngle(a.z, a.x, b.z, b.x)), _Vector.normalizeAngle(_Vector.find2DAngle(a.x, a.y, b.x, b.y)));
    }
    ...
    return new _Vector(_Vector.normalizeAngle(alpha), _Vector.normalizeAngle(beta), _Vector.normalizeAngle(gamma));
  }
  /**
  ...
  static angleBetween3DCoords(a, b, c) {
    ...
    return _Vector.normalizeRadians(angle);
  }
  /**
  ...
  static getRelativeSphericalCoords(a, b, c, axisMap) {
    ...
    const phi = phi1 - phi2;
    return {
      theta: _Vector.normalizeAngle(theta),
      phi: _Vector.normalizeAngle(phi)
    };
  }
  /**
  ...
  static getSphericalCoords(a, b, axisMap = { x: "x", y: "y", z: "z" }) {
    ...
    return {
      theta: _Vector.normalizeAngle(-theta),
      phi: _Vector.normalizeAngle(PI / 2 - phi)
    };
  }
};
...
var Euler = class _Euler {
   ...
   */
  multiply(v) {
    return new _Euler(this.x * v, this.y * v, this.z * v, this.rotationOrder);
  }
};
...
//# sourceMappingURL=kalidokit.js.map
