...
var D = (n, t, s) => t in n ? C(n, t, { enumerable: true, configurable: true, writable: true, value: s }) : n[t] = s;
var r = (n, t, s) => D(n, typeof t != "symbol" ? t + "" : t, s);
function x(n) {
  return n.length ? n.reduce((t, s) => t + s, 0) / n.length : 0;
}
var e = ((n) => (n.sil = "viseme_sil", n.PP = "viseme_PP", n.FF = "viseme_FF", n.TH = "viseme_TH", n.DD = "viseme_DD", n.kk = "viseme_kk", n.CH = "viseme_CH", n.SS = "viseme_SS", n.nn = "viseme_nn", n.RR = "viseme_RR", n.aa = "viseme_aa", n.E = "viseme_E", n.I = "viseme_I", n.O = "viseme_O", n.U = "viseme_U", n))(e || {});
var _ = {
  [e.sil]: "silence",
  [e.PP]: "plosive",
  [e.FF]: "fricative",
